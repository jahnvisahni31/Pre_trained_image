...
def get_input_args():
    ...
    parser.add_argument('--arch', type=str,default='vgg',help=' which CNN model to use for classification')
    parser.add_argument('--dogfile', type=str , default='dognames.txt',help='path to text file with names of dogs.')
