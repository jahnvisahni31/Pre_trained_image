...
#                                                                             
# PROGRAMMER: jahnvi sahni 
# DATE CREATED: 30-10-2023                                 
# REVISED DATE: 06-11-2023
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic:
        ...
        #
        percentage_keys = [key for key in results_stats_dic if key.startswith('p')]
        for key in percentage_keys:
            key_name = key.lstrip('p')
            print(f'Percentage {key_name.capitalize()}: {results_stats_dic[key]}%') 
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            # Iterate through the keys in results_dic
            for key in results_dic:
                if (results_dic[key][3] == 1 and results_dic[key][2] == 0) or (results_dic[key][3] == 0 and results_dic[key][2] == 1):
